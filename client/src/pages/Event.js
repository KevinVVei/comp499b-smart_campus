...
function Event() {
  ...
  //passes the data from the new event 
  //created by the user to store in the db
  ...
  return (
    <div className='events-page'>
      ...
      {/*filter container stores the filter options and button*/}
      <div className='event-search'>
        ...
        {/*search bar and button calls the searchEvent function passing the search value*/}
      ...
      {!error ?
        <span>
        {/*displays a pop to input info for a new event*/}
        {newEvent ?
          <div id='overlay2'>
            <div className='new-event-form'>
              <form onSubmit={handleSubmit}>
                ...
                <select name="event-type" value={type} onChange={(e) => setType(e.target.value)}>
                  <option value="University">University</option>
                  <option value="Personal">Personal</option>
                </select><br/>
                <label>Details: </label><br/>
                <textarea value={details} onChange={(e) => setDetails(e.target.value)} required/><br />
                <div id='option-btns'>
