    ...
    return (
        <div className="CourseHomePage">  
            ...
            <div className='course-search'>
                ...
                <input id='c-search-input' type='text' placeholder='Search courses...' autoComplete='off' onChange={(e)=> {setSearchTerm(e.target.value)}} onKeyDown={(e) => {if (e.key === 'Enter') {searchCourse()}}}/>
